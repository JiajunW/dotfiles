# Generated by Powerlevel10k configuration wizard on 2026-04-07 at 21:57 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    conan                   # conan environment for cpp develop
  ...
  function prompt_conan() {
    if [[ -z $CONAN_OLD_PATH ]]; then
      # have not activated the conan environment
      return
    fi
    p10k segment -b 57 -f 250 -i ''
  }
